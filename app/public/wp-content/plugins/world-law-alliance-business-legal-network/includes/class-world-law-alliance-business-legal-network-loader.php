 ...
 */
class World_Law_Alliance_Business_Legal_Network_Loader {
	 ...
	 *
	 * @since    1.0.0
	 * @param    string   $shortcode   The name of the shortcode being registered.
	 * @param    object   $component   A reference to the instance of the object on which the shortcode is defined.
	 * @param    string   $callback    The name of the function definition on the $component.
	 */
	public function add_shortcode( $shortcode, $component, $callback ) {
		$this->shortcodes = $this->add_shortcode_internal( $this->shortcodes, $shortcode, $component, $callback );
	}
	 ...
	 */
	private function add_shortcode_internal( $shortcodes, $shortcode, $component, $callback ) {
		$shortcodes[] = array(
			'shortcode'   => $shortcode,
			'component'   => $component,
			'callback'    => $callback,
